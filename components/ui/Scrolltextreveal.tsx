...
export function WhoWeAre() {
  return (
    <section className="relative bg-black min-h-screen px-6 py-20 overflow-hidden">
      ...
      <MaskContainer
        ...
        revealText={
          <div className="text-center text-4xl font-bold text-white">
            Building a digital playground for makers & thinkers.
          </div>
        }
      >
        <div className="max-w-5xl mx-auto grid gap-8 text-left text-white">
          <motion.h2
            className="text-6xl font-bold font-LemonMilk tracking-wide uppercase text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-purple-300"
            initial={{ y: 50, opacity: 0 }}
            whileInView={{ y: 0, opacity: 1 }}
